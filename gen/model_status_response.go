...
type StatusResponse struct {
	// Document category name example: Financial Reports
	Category *string `json:"category,omitempty"`
	// Average confidence score of OCR results (null if job not completed) example: 94.8
	ConfidenceScore *float32 `json:"confidence_score,omitempty"`
	// When the job was created example: 2024-01-15T10:30:00Z
	...
	// Percentage of pages processed example: 100
...
func (o *StatusResponse) GetCategory() string {
...
func (o *StatusResponse) GetCategoryOk() (*string, bool) {
	if o == nil || IsNil(o.Category) {
		return nil, false
	}
...
func (o *StatusResponse) HasCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *StatusResponse) SetCategory(v string) {
	o.Category = &v
}

// GetConfidenceScore returns the ConfidenceScore field value if set, zero value otherwise.
func (o *StatusResponse) GetConfidenceScore() float32 {
...
// and a boolean to check if the value has been set.
func (o *StatusResponse) GetConfidenceScoreOk() (*float32, bool) {
	if o == nil || IsNil(o.ConfidenceScore) {
		return nil, false
	}
...
func (o *StatusResponse) HasConfidenceScore() bool {
	if o != nil && !IsNil(o.ConfidenceScore) {
		return true
	}
...
func (o *StatusResponse) SetConfidenceScore(v float32) {
	o.ConfidenceScore = &v
}
...
func (o *StatusResponse) GetProgressPercentage() float32 {
...
// and a boolean to check if the value has been set.
func (o *StatusResponse) GetProgressPercentageOk() (*float32, bool) {
	if o == nil || IsNil(o.ProgressPercentage) {
		return nil, false
	}
...
func (o *StatusResponse) HasProgressPercentage() bool {
	if o != nil && !IsNil(o.ProgressPercentage) {
		return true
	}
...
func (o *StatusResponse) SetProgressPercentage(v float32) {
